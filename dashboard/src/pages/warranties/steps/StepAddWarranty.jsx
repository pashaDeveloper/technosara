...
import { useAddWarrantyMutation } from "@/services/warranty/warrantyApi";
...
const StepAddWarranty = () => {
  ...
  const [addWarranty, { isLoading, data, error }] = useAddWarrantyMutation();
...
console.log(data);
  ...
  useEffect(() => {
    if (isLoading) {
      toast.loading("در حال افزودن دسته بندی...", { id: "addWarranty" });
    }
