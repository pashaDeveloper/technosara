    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            جدیدترین موبایل‌ها و لوازم جانبی با بهترین قیمت
          </motion.h2>
          <motion.p
          ...
          >
            در فروشگاه ما می‌توانید انواع گوشی‌های هوشمند، هدفون، شارژر، محافظ
            صفحه و سایر لوازم جانبی موبایل را با ضمانت اصالت و بهترین قیمت تهیه
            کنید.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
          ...
          >
            <Link
              href="/shop"
              className="w-full md:w-52 mb-5 md:mb-12 inline-block text-center bg-black hover:bg-black/80 transition-all text-white px-6 py-4 rounded-full hover:animate-pulse"
            >
              مشاهده محصولات
            </Link>
          </motion.div>
          <motion.div
            ...
            className="flex md:h-full md:max-h-11 lg:max-h-[52px] xl:max-h-[68px] items-center justify-center md:justify-start flex-wrap sm:flex-nowrap md:gap-x-3 lg:space-x-6 xl:space-x-8 md:mb-[116px]"
          >
